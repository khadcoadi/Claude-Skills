...
APP_ID="ce17f4d7-2672-4a67-9939-a7dbf012f7bd"
CLIENT_SECRET="~1P8Q~xxp0LdnKFDzdUccT2MnHv-WGTfpiJACawq"

# --- CONSTANTS ---
SERVICE_URL="https://smba.trafficmanager.net/teams"
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
ROSTER_FILE="${SCRIPT_DIR}/team-roster.json"
TOKEN_CACHE="/tmp/pixel-token-cache.json"
CONV_CACHE="/tmp/pixel-conversations.json"
